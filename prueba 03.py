...
with open(archivo_salida, "w", encoding="utf-8") as f:
    while True:
        ...
        if linea.lower() == 'salir':  # Acepta salir en mayúsculas o minúsculas
            print(f"\n✅ Texto guardado correctamente en: {archivo_salida}")
            break
        ...
        for palabra in palabras:
            if palabra.endswith("*"):
                ...
                if coincidencias:
                    ...
                    print(f"\033[91mNo hay sugerencia para '{base}', corrigiendo...\033[0m")
